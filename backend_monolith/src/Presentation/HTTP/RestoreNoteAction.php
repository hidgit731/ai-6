...
#[AsController]
#[Route('/api/notes/{id}/restore', methods: ['POST'], requirements: ['id' => '[0-9a-f\-]++'])]
final class RestoreNoteAction
{
    public function __invoke(
        ...
        if (!$note->isDeleted()) {
            return new JsonResponse(['message' => 'Note is not deleted'], Response::HTTP_CONFLICT);
        }
